...
def get_modeling_guidance(
    ...
    faces with holes, architecture for units, walls/slabs/openings and Grasshopper,
    organization for layer assignment, verification for checking results, or recovery
    after uncertain edits. overview lists the workflow and topics. Works without a
    Rhino connection; does not change documents.
    """
