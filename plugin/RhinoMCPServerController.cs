...
namespace RhinoMCPPlugin
{
    class RhinoMCPServerController
    {
        ...
        public static void StartServer()
        {
            ...
            server.Start();
            if (!server.IsRunning())
                RhinoApp.WriteLine("RhinoMCP Studio could not start. Check whether another Rhino session is using port 1999, then run StudioMCPStart.");
        }
        ...
        {
            // Used by StudioMCPVersion / status — must reflect actual state, not just
