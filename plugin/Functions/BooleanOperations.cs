...
public partial class RhinoMCPFunctions
{
    ...
    public JObject BooleanUnion(JObject parameters)
    {
        ...
        var resultIds = CommitBrepResults(doc, results, name, "Boolean union",
            deleteSources ? sourceObjects : null);
    ...
    public JObject BooleanDifference(JObject parameters)
    {
        ...
        var resultIds = CommitBrepResults(doc, results, name, "Boolean difference",
            deleteSources ? new[] { baseObj }.Concat(subtractObjects) : null);
    ...
    public JObject BooleanIntersection(JObject parameters)
    {
        ...
        var resultIds = CommitBrepResults(doc, results, name, "Boolean intersection",
            deleteSources ? sourceObjects : null);
    ...
    private JObject PredictBoolean(Brep[] results, string message)
    {
        ...
        {
            ["dry_run"] = true,
            ["would_succeed"] = results.All(brep => brep != null && brep.IsValid),
            ["count"] = results.Length,
            ["results"] = predicted,
            ["message"] = message
        };
